// from: https://raw.githubusercontent.com/lprhodes/homebridge-broadlink-rm/master/helpers/learnData.js
...
const start = (host, callback, turnOffCallback, log, disableTimeout) => {
    ...
    if (!device) {
        setTimeout(() => { start(host, callback, turnOffCallback, log, disableTimeout) }, 1000);
        return
    }
...
start(process.argv[2], null, _turnOffCallback, console.log, true);
